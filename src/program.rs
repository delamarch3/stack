...
impl std::fmt::Display for Bytecode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Bytecode::B2I => "b2i".fmt(f),
            Bytecode::B2L => "b2l".fmt(f),
            Bytecode::Cmp => "cmp".fmt(f),
            Bytecode::CmpB => "cmp".fmt(f),
            ...
            Bytecode::I2B => "i2b".fmt(f),
            Bytecode::I2L => "i2l".fmt(f),
