...
impl Assembler {
    ...
    fn assemble_instruction(&mut self, word: &str) -> Result<()> {
        match word {
            ...
            "load" => self.assemble_operator_with_operand::<u64>(Bytecode::Load)?,
            ...
            "store" => self.assemble_operator_with_operand::<u64>(Bytecode::Store)?,
            ...
            "get" => self.assemble_operator_with_operand::<u64>(Bytecode::Get)?,
            ...
            "cmp" => self.assemble_operator(Bytecode::Cmp),
